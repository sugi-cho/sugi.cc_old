    ...
    void BuildProjections()
    {
        ...
        for (var y = 0; y < numY; y++)
        {
            ...
            for (var x = 0; x < numX; x++)
            {
                ...
                projection.SetupCamera();
                projection.SetTexture(original);
        ...
        void QuadWarpPropField()
        {
            ...
            for (var y = 0; y < numY; y++)
                for (var x = 0; x < numX; x++)
                {
                    ...
                    var i = numX * y + x;
                    GUILayout.BeginHorizontal();
                    quadWarpProps[i + 2] = Vector2Field("UpperLeft:", quadWarpProps[i + 2]);
                    quadWarpProps[i + 3] = Vector2Field("UpperRight:", quadWarpProps[i + 3]);
                    GUILayout.EndHorizontal();
                    GUILayout.BeginHorizontal();
                    quadWarpProps[i + 0] = Vector2Field("BottomLeft:", quadWarpProps[i + 0]);
                    quadWarpProps[i + 1] = Vector2Field("BottomRight:", quadWarpProps[i + 1]);
                    GUILayout.EndHorizontal();
                    GUILayout.Space(16f);
                }
        }
